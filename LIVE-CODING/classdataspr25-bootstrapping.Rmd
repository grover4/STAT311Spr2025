...
Fill in the blanks in the code chunk below to implement the bootstrap method to draw 1,000 new samples of size $n = 127$ from the bootstrapped population, and calculate the mean number of `credits` for each.  
